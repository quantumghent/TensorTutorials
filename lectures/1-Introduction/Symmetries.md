...
- In this brief overview we mostly neglected spatial symmetries. Spatial symmetries can be understood as transformations that translate, rotate or reflect the lattice. These kind of symmetries thus don't act "on site" anymore. We encountered the example of translation symmetry, but the classification of spatial symmetry groups is notoriusly rich and complex, especially in higher dimensions. It should be noted that exploiting these symmetries in tensor networks can result in tremendous numerical speedup and stability.